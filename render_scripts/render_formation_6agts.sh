...
do
    ...
    --use_att_gnn "False" \
    --model_dir "/data/goufandi_space/Projects/InforMARL/onpolicy/results/GraphMPE/graph_formation_6agts/rmappo/check/wandb/run-20241010_104308-h37y1fhz/files/"
done